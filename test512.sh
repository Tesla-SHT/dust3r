...
torchrun --nproc_per_node=4 train.py \
    --train_dataset "50 @ TartanAir(split='train', ROOT='/run/determined/workdir/data/feed_forward_event/Tartanair_tmp/indoor', aug_crop=16, mask_bg='rand', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], transform=ColorJitter)" \
